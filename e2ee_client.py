...
def save_keys(private_key, public_key, user_phoneNumber):
    ...
    os.makedirs("client_db", exist_ok=True)
    
    # Save the private key locally
    with open(f"client_db/{user_phoneNumber}_private_key.pem", "wb") as file:
...
def load_private_key(user_phoneNumber):
    with open(f"client_db/{user_phoneNumber}_private_key.pem", "rb") as file:
...
def add_user_info():
    ...
    # Save object
    with open("client_db/user_data.json", "w") as file:
...
def collect_data_from_db():
    global user_info
    # Load object
    with open("client_db/user_data.json", "r") as file:
